...
OUTPUT_JSON = os.path.abspath(os.path.join(SCRIPT_DIR, "..", "..", "global_output", "sources", "PhishTank", "collection", "phishtank_data.json"))
...
def main():
    ...
    if new_records:
        logging.info(f"Nouveaux items ajoutés : {len(new_records)}")
