...
OUTPUT_JSON = os.path.abspath(os.path.join(SCRIPT_DIR, "..", "..", "global_output", "sources", "Otx alienvault", "collection", "otx_pulses.json"))
...
def sync_pulses(otx, modified_since, existing_data, existing_ids, tracking, new_pulses_list, mode="AFTER"):
    ...
    # Save daily export if new pulses were found removed
