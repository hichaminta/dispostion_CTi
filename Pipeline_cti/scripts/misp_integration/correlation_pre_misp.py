...
class ThreatCorrelator:
    ...
    def process_files(self):
        ...
        import glob
        all_files = glob.glob(os.path.join(BASE_DIR, "Pipeline_cti", "global_output", 'sources', '*', 'enrichment', '*.json'))
...
if __name__ == "__main__":
    ...
    OUTPUT_DIR = args.output or os.path.join(BASE_DIR, "Pipeline_cti", "global_output", "output_correlation")
