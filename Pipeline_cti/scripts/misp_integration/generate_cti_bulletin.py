...
class CTIBulletinGenerator:
    def __init__(self, output_dir="Pipeline_cti/global_output/reports/cti_bulletins"):
...
def main(input_file=None):
    ...
    out_corr_dir = os.path.join(base_dir, "Pipeline_cti", "global_output", "output_correlation")
    output_dir = os.path.join(base_dir, "Pipeline_cti", "global_output", "reports", "cti_bulletins")
