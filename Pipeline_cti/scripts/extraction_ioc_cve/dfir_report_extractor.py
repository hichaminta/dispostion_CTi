...
SOURCE_DIR = os.path.join(BASE_DIR, "Pipeline_cti", "global_output", "sources", "The DFIR Report", "collection")
...
OUTPUT_DIR = os.path.join(BASE_DIR, "Pipeline_cti", "global_output", "sources", "The DFIR Report", "extraction")
...
def _make_ioc_record(article: dict, iocs: list, cves: list, tags: list, nlp_analysis: dict = None) -> dict:
    """Format pour Pipeline_cti/global_output/output_cve_ioc — sera traité par l'enrichissement IOC normal.
...
def _make_vuln_record(article: dict, cves: list, tags: list, nlp_analysis: dict = None) -> dict:
    """
    Format pour Pipeline_cti/global_output/output_enrichment — bypass enrichissement IOC.
    Aucun IOC, uniquement CVE + contexte article.
    La corrélation le lira directement depuis Pipeline_cti/global_output/output_enrichment/.
    """
