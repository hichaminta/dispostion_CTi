...
SOURCE_DIR = os.path.join(BASE_DIR, "Pipeline_cti", "global_output", "sources", "OpenPhish", "collection")
INPUT_FILE = os.path.join(SOURCE_DIR, "openphish_data.json")
OUTPUT_DIR = os.path.join(BASE_DIR, "Pipeline_cti", "global_output", "sources", "OpenPhish", "extraction")
