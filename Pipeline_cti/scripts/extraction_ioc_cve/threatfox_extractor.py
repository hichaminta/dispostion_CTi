...
SOURCE_DIR = os.path.join(BASE_DIR, "Pipeline_cti", "global_output", "sources", "ThreatFox", "collection")
INPUT_FILE = os.path.join(SOURCE_DIR, "threatfox_data.json")
OUTPUT_DIR = os.path.join(BASE_DIR, "Pipeline_cti", "global_output", "sources", "ThreatFox", "extraction")
...
def run_extraction():
    ...
    output_path = os.path.join(OUTPUT_DIR, "threatfox_extracted.json")
    all_results = []
