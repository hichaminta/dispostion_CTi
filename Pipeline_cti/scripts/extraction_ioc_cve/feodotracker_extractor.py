...
SOURCE_DIR = os.path.join(BASE_DIR, "Pipeline_cti", "global_output", "sources", "feodotracker", "collection")
INPUT_FILE = os.path.join(SOURCE_DIR, "feodotracker_data.json")
OUTPUT_DIR = os.path.join(BASE_DIR, "Pipeline_cti", "global_output", "sources", "feodotracker", "extraction")
...
def run_extraction():
    ...
    output_path = os.path.join(OUTPUT_DIR, "feodotracker_extracted.json")
    all_results = []
