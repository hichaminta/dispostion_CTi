...
SOURCE_DIR = os.path.join(BASE_DIR, "Pipeline_cti", "global_output", "sources", "PhishTank", "collection")
INPUT_FILE = os.path.join(SOURCE_DIR, "phishtank_data.json")
OUTPUT_DIR = os.path.join(BASE_DIR, "Pipeline_cti", "global_output", "sources", "PhishTank", "extraction")
...
def run_extraction():
    ...
    output_path = os.path.join(OUTPUT_DIR, "phishtank_extracted.json")
    all_results = []
