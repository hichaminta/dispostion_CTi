...
SOURCE_DIR = os.path.join(BASE_DIR, "Pipeline_cti", "global_output", "sources", "url", "collection")
INPUT_FILE = os.path.join(SOURCE_DIR, "urlhaus_data.json")
OUTPUT_DIR = os.path.join(BASE_DIR, "Pipeline_cti", "global_output", "sources", "url", "extraction")
TRACKING_DIR = os.path.join(EXTRACTORS_DIR, "tracking")
TRACKING_FILE = os.path.join(TRACKING_DIR, "urlhaus_tracking.json")
...
def run_extraction():
    ...
    output_path = os.path.join(OUTPUT_DIR, "urlhaus_extracted.json")
    all_results = []
