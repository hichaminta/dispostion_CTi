...
SOURCE_DIR = os.path.join(BASE_DIR, "global_output", "sources", "Otx alienvault", "collection")
INPUT_FILE = os.path.join(SOURCE_DIR, "otx_pulses.json")
OUTPUT_DIR = os.path.join(BASE_DIR, "global_output", "sources", "Otx alienvault", "extraction")
