...
SOURCE_DIR = os.path.join(BASE_DIR, "global_output", "sources", "feodotracker", "collection")
INPUT_FILE = os.path.join(SOURCE_DIR, "feodotracker_data.json")
OUTPUT_DIR = os.path.join(BASE_DIR, "global_output", "sources", "feodotracker", "extraction")
