...
SOURCE_DIR = os.path.join(BASE_DIR, "global_output", "sources", "PhishTank", "collection")
INPUT_FILE = os.path.join(SOURCE_DIR, "phishtank_data.json")
OUTPUT_DIR = os.path.join(BASE_DIR, "global_output", "sources", "PhishTank", "extraction")
