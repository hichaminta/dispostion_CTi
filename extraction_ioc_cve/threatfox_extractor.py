...
SOURCE_DIR = os.path.join(BASE_DIR, "global_output", "sources", "ThreatFox", "collection")
INPUT_FILE = os.path.join(SOURCE_DIR, "threatfox_data.json")
OUTPUT_DIR = os.path.join(BASE_DIR, "global_output", "sources", "ThreatFox", "extraction")
