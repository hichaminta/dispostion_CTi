...
SOURCE_DIR = os.path.join(BASE_DIR, "global_output", "sources", "CINS Army", "collection")
INPUT_FILE = os.path.join(SOURCE_DIR, "cins_army_data.json")
OUTPUT_DIR = os.path.join(BASE_DIR, "global_output", "sources", "CINS Army", "extraction")
