...
SOURCE_DIR = os.path.join(BASE_DIR, "Sources_data", "AbuseIPDB")
INPUT_FILE = os.path.join(SOURCE_DIR, "abuseipdb_data.json")
...
def run_extraction():
    ...
    output_path = os.path.join(OUTPUT_DIR, "abuseipdb_extracted.json")
    all_results = []
