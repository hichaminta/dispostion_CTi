...
SOURCE_DIR = os.path.join(BASE_DIR, "global_output", "sources", "pulsedive", "collection")
INPUT_FILE = os.path.join(SOURCE_DIR, "pulsedive_data.json")
OUTPUT_DIR = os.path.join(BASE_DIR, "global_output", "sources", "pulsedive", "extraction")
...
def run_extraction():
    ...
    output_path = os.path.join(OUTPUT_DIR, "pulsedive_extracted.json")
    all_results = []
