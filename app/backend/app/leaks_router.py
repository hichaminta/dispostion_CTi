...
INTEL_FILE = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "..", "leak_data_integration", "output", "results", "leaks_intel.json"))
...
LEAKS_DATA_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "..", "leak_data_integration", "output", "data", "leaks"))
...
def get_pdf_bulletin(intel_id: str):
    ...
    pdf_path = os.path.join(INTEGRATION_DIR, "..", "Pipeline_cti", "global_output", "reports", f"bulletin_{intel_id}.pdf")
...
def delete_leak(intel_id: str):
    ...
    base_data = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "..", "leak_data_integration", "output", "data", "leaks"))
    ...
    pdf_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "..", "Pipeline_cti", "global_output", "reports", "fuite", f"Bulletin_Fuite_{safe_id}.pdf"))
    try:
...
async def upload_csv(file: UploadFile = File(...)):
    ...
    base_data = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "..", "leak_data_integration", "output", "data", "leaks", "uploads"))
