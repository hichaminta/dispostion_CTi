...
app.mount("/data", StaticFiles(directory=os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "..", "leak_data_integration", "output", "data"))), name="data")
...
app.mount("/bulletins_files", StaticFiles(directory=os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "..", "Pipeline_cti", "global_output", "reports", "cti_bulletins"))), name="bulletins_files")
...
async def get_stix_data():
    ...
    """
    out_dir = os.path.join(os.path.dirname(__file__), "..", "..", "..", "Pipeline_cti/global_output/output_correlation")
    try:
